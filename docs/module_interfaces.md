...
| IF-T04-FLOWER-01 底部取球 | PROPOSED v0.3 | C04-B1为首个原型：拨杆只在底部Retrieval Opening内横扫并抬升最下方POLLEN，出底部边界后经偏置导流进入标准roller；真实侧面出口C04-B2禁止。C04-A保留回退。容量达到4时禁止继续获取；约10 N串联弹簧限力，不得抓持FLOWER。 | STEP横向自由截面、合法底部边界、对位基准、峰值取出力、侧向楔球与卡球恢复 |
