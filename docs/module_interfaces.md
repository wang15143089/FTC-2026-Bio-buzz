...
| IF-T04-FLOWER-01 底部取球 | PROPOSED v0.4 | C04-B1采用从官方FLOWER模型−X朝−Y偏25°的斜向侧拨：3×20×32 mm拨片动力行程60 mm，Ø71 mm球验证至120 mm，路径距离116 mm处由Ø60×120 mm标准roller接管；6 V舵机暂按3.2:1减速。纯−X横移淘汰，C04-B2禁止，C04-A保留回退。容量达到4时禁止继续获取，约10 N串联弹簧限力，不得抓持FLOWER。 | 3.680 mm名义支柱余量的实物公差、对位基准、舵机型号/外形/行程、电源瞬态、峰值取出力和卡球恢复 |
