...
| IF-T04-FLOWER-01 底部取球 | PROPOSED v0.2 | C04-A 采用4 mm上方薄拨叉、12 mm落钩和60 mm顺从roller；仅从 Retrieval Opening 底部逐个取POLLEN。容量达到4时禁止继续获取；拨叉以约10 N串联弹簧限力，不得抓持FLOWER。 | 实物开口/球差、拨叉横向宽度、对位基准、峰值取出力、卡球恢复 |
